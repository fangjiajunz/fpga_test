module lcd_display (
    ...
    localparam [15:0] COLOR_BLUE  = 16'b00000_000000_11111;
    ...
    always @(posedge lcd_pclk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            pixel_data <= COLOR_BLACK;
        end else if (pixel_xpos < bar_width) begin
            pixel_data <= COLOR_WHITE;
        end else if (pixel_xpos < bar_width * 2) begin
            pixel_data <= COLOR_BLACK;
        end else if (pixel_xpos < bar_width * 3) begin
            pixel_data <= COLOR_RED;
        end else if (pixel_xpos < bar_width * 4) begin
